<?
	...
	$sqlaLL = "SELECT * FROM ".$cid."_temp_employee_data  WHERE team in (".$teamsArrayString.") AND id = '".$_REQUEST['hiddenrowidfororg']."'";
	...
	foreach ($fieldsArray as $keyfield1 => $valuefield1) {
		...
		$dbc->query("UPDATE ".$_SESSION['rego']['cid']."_temp_employee_data SET  ".$keyfield1." = '".$valuefield1."' WHERE id= '".$_REQUEST['hiddenrowidfororg']."'");
