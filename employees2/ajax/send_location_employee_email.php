<?
	...
	$encodeEmpId =base64_encode(base64_encode($_REQUEST['employee_id']));
	$encodeCid =base64_encode(base64_encode($_SESSION['rego']['cid']));
	$urlLink =  ROOT.''.$folderName.'/'.$fileName.'?emp_id='.$encodeEmpId.'&cid='.$encodeCid.'' ;

	// update the link-expire back to null or 0 

	$sql_update = "UPDATE ".$_SESSION['rego']['cid']."_employees SET ping_expire = '0' WHERE emp_id = '".$_REQUEST['employee_id']."'";
            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table id="d" class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td background="#41abe2" bgcolor="#41abe2" width="600" height="50" valign="top" align="center" style=""> 
                        <p style="color: #ffffff; font-size: 21px;text-align: center;font-family: Verdana, Geneva, sans-serif; line-height: 61px; margin: 2px;  padding: 0; float:left; margin-left:19px;">Ping Location Notification
                          </p>
                      </td>
                  </tr>
                </table>
                ...
                <table id="d" class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0;" bgcolor="#FFFFFF">
                  <tr>
                    <td > 
                        <p style="color:#011e40; font-size: 14px; text-align: left; font-family: Verdana, Geneva, sans-serif; line-height: 45px; margin: -2px; padding: 0; padding: 0px 13px;">Please follow this link to ping your current location <img src="https://regodemo.com/images/loc.png" alt="" width="22" height="22" style="border-width:0; max-width:12px;height:auto; float: none; margin-top: 14px;" align="left"/></p><br>
...
&nbsp; <a href="'.$urlLink.'">Click Here to Continue</a>	
...
<td style="text-align:center; padding:0px 10px 10px 10px;" >
			<img src="https://regodemo.com/images/web.png" alt="" width="22" height="22" style="border-width:0; max-width:12px;height:auto;; float: none; margin-top: 4px;" align="left"/> <i class="fa fa-map-marker" aria-hidden="true"></i> Visit us at <a href="https://www.regodemo.com">www.regodemo.com</a>
			</td>
			</tr>
		...
		$mail->addAddress($_REQUEST['selectedEmail'], 'Test Email'); 
		$mail->isHTML(true);                                  
