<?
	...
	include('../payroll/inc/tax_modulle.php');
	...
	$id = $_GET['id'];
	$data = array();
	$xdata = getEmployeeTaxdata($id, $_SESSION['payroll']['payroll_dbase'], $_SESSION['xhr']['emp_dbase']);
	$data = $xdata['data'];
...
$mpdf->WriteHTML($html);
//$mpdf->Output();
$mpdf->Output($_SESSION['xhr']['id'].'_annual_payroll_overview_employee.pdf','I');
exit;
