								...
								<? if(isset($alltempdata) && is_array($alltempdata)){ 
										foreach ($alltempdata as $key => $value) { ?>
											...
											<tr data-id="<?=$value['emp_id']?>">
												...
												<td><?=$value['calc_base']?></th>
            									<td><?=$value['bank_code']?></th>
            									<td><?=$value['bank_name']?></th>
            									<td><?=$value['bank_branch']?></th>
            									<td><?=$value['bank_account']?></th>
            									<td><?=$value['bank_account_name']?></th>
            									<td><?=$value['pay_type']?></th>
            									<td><?=$value['account_code']?></th>
            									<td><?=$value['groups']?></th>
            									<td><?=$value['calc_method']?></th>
            									<td><?=$value['calc_tax']?></th>
            									<td><?=$value['tax_residency_status']?></th>
            									<td><?=$value['income_section']?></th>
            									<td><?=$value['modify_tax']?></th>
            									<td><?=$value['calc_sso']?></th>
            									<td><?=$value['sso_by']?></th>
