...
<body style="">
	...
	<div style="text-align:center;background:<?php echo $savedAdminColors[$scanLoginSystemDataValue['select_scan_login_heading_color']]['code'].'!important'; ?>; " class="header" >
		<span style="font-family:<?php echo $getDefaultFonts[$scanLoginSystemDataValue['select_scan_login_heading_font']].'!important'; ?>;">Rego Demo <?=$lng['Time registration']?></span> 
	</div>			
