		...
		<div class="log-body">
			...
			<div id="logForm">	
				<form id="log_form" style="padding:0 0 10px 0">
					...
					<div class="row">
						<div class="col-md-12">
							<button id="generateloc" type="button" class="btn btn-danger btn-lg btn-block tac" style="margin-top:10px!important;margin: 0px; font-weight:400; letter-spacing:1px"><?=$lng['Re-generate Location']?> &nbsp;<i class="fa fa-sign-in fa-lg"></i></button>
						</div>
					</div>					
					<div class="row">
						<div class="col-md-12">
							<button id="svButton" type="button" class="btn btn-success btn-lg btn-block tac" style="background: #61bc47;margin-top:10px!important;margin: 0px; font-weight:400; letter-spacing:1px"><?=$lng['Save']?> &nbsp;<i class="fa fa-sign-in fa-lg"></i></button>
						</div>
					</div>
