...
<div class="A4form" style="width:900px;height:1260px; padding:30px 30px 100px; background:#fff url(<?=ROOT?>images/forms/pnd1_en.png?<?=time()?>) no-repeat; background-size:cover">
	...
	<div class="field13n" style="top:215.8mm;left:111mm"><?=$emps?></div>

	<div class="field13n" style="top:159.6mm;left:146.6mm"><?=$income?></div>
	...
	<div class="field13n" style="top:159.6mm;left:181.4mm"><?=$tax?></div>
