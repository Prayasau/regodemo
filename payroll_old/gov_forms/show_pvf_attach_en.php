...
?>	
 ...
 <!--<div style="width:210mm;margin:0 auto;margin-top:10px; background:#fff; padding:30px 30px 100px; height:297mm; box-shadow:0 0 10px rgba(0,0,0,0.5);">-->
			<form id="pnd1_attach">
			<div style="font-size:16px; margin-bottom:5px"><b>Attachment remittance incomes members</b></div>
			<table class="toptable" border="0" style="border-bottom:0;">
				<tr>
					...
					<td>
						Month : <b><span class="formMonth"><?=$_SESSION['rego']['formdate']['m'].'</b></span> <b><span class="formYear">'.$_SESSION['rego']['formdate'][$lang.'y']?></span></b><br>
			...
			<table class="taxtable" border="1">
				...
				<tr>
					<th>Item</th>
					<th>Tax ID</th>
					<th style="width:50%">Name employee</th>
					<th class="tar" style="min-width:110px">PVF employee</th>
					<th class="tar" style="min-width:110px">PVF employer</th>
					<th class="tar" style="min-width:110px">Total</th>
				</tr>
				</thead>
				<tbody>
				...
				<? } } ?>
				<tr>
					<th class="tar" colspan="3"><b>Total</b></th>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$(document).on("click", ".print", function(e) {
				window.open(ROOT+'payroll/print/print_pvf_attach_en.php?'+$(this).data('type'), '_blank')
			});
