			...
			<table id="datatable" class="dataTable hoverable selectable nowrap compact tar" border="0">
				<thead>
					...
					<tr>
						...
						<th data-sortable="false" style="min-width:1px;"><i title="<?=$lng['Tax calculation']?>" data-toggle="tooltip" class="fa fa-calculator" style="font-size:14px"></i></th>
						<th data-sortable="false" style="min-width:1px;"><i title="<?=$lng['Show Payslip']?>" data-toggle="tooltip" class="fa fa-product-hunt" style="font-size:14px"></i></th>
						<th data-visible="false" style="min-width:1px;"><i title="<?=$lng['Employee year totals']?>" data-toggle="tooltip" class="fa fa-list" style="font-size:14px"></i></th>
					...
					<td style="padding:0 7px; vertical-align:top; width:25%"> <!--CENTER TABLE-->
						<table class="editTable">
							...
							<tbody>
								...
								<tr>
									<td><?=$lng['Absence']?></td>
									<td class="tar" id="absence_b1">0</td>
								</tr>
								<tr>
									<td><?=$lng['Late Early']?></td>
									<td class="tar" id="late_early_b1">0</td>
								</tr>
								<tr>
									<td><?=$lng['Leave WOP']?></td>
									<td class="tar" id="leave_wop_b1">0</td>
								</tr>
								<tr>
