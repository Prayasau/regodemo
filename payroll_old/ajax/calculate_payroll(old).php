<?php
	...
	// SSO MONTH /////////////////////////////////////////////////////////////////
			...
			if($row['calc_sso']){
				...
				//$sso_emp = (($this_salary + $tot_fix_all + $row['remaining_salary']) - $row['leave_wop_b']) * $sso_rate_emp;
				...
				//$sso_com = (($this_salary + $tot_fix_all + $row['remaining_salary']) - $row['leave_wop_b']) * $sso_rate_com;
	...
	// PAYROLL OVERVIEW ////////////////////////////////////////////////////////////////
			...
			//$netincomeNew = $this_salary - $tot_deductions;
