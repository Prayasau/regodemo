<?php
	...
	$table .= '			
				<tr><td>'.$lng['Social security fund'].'</td><td style="text-align:right;color:#c00">- '.number_format($data['tot_ssf'],2).'</td></tr>
				<tr><td>'.$lng['Provident fund'].'</td><td style="text-align:right;color:#c00">- '.number_format($data['tot_pvf'],2).'</td></tr>
		...
		$table .= '	
				<tr><td>'.$lng['Tax month'].'</td><td style="text-align:right"><b>'.number_format($data['tax_month'],2).'</b></td></tr>
				<tr><td>'.$lng['Modify tax'].'</td><td style="text-align:right;'.$mcolor.'">'.number_format($data['tax_modify'],2).'</td></tr>';
				}
		$table .= '			
				<tr><td>'.$lng['Tax this month'].'</td><td style="text-align:right"><b>'.number_format($data['tax_this_month'],2).'</b></td></tr>
				</tbody>
			</table>';
