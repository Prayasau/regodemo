...
<style>
	...
	$header = '
		<div style="font-size:16px; float:left; width:80%; border:0px solid red">
			<b>'.$xdata['en_compname'].' ('.strtoupper($_SESSION['rego']['cid']).') - PND1 Attachment - '.$months[(int)$_SESSION['rego']['gov_month']].' '.$_SESSION['rego']['cur_year'].'</b>
		</div>
	...
	$html .= '
				<tr>
					<th colspan="4" style="text-align:right"><b>Total amount of income and withholding tax remittance</b>&nbsp;&nbsp;(to be included with other attachement of P.N.D.1 (if any))</th>
