...
$header = '<div style="width:50%;font-size:16px;border:0px solid red"><b>รายงานเงินนำส่งรายสมาชิก</b></div>
			...
			<table class="toptable" border="0">
				...
				<tr>
					<th style="width:65%">
						...
						เลขประจำตัวผู้เสียภาษีอากร : <b>'.$edata['tax_id'].'</b><br />
						ลำดับสาขาที่ : <b>'.$branch.'</b>
						
						
					</th>	
					<th style="">
						แผ่นที่ {PAGENO} ในจำนวน {nbpg} แผ่น<br>
						สำหรับค่าจ้างเดือน : <b>'.$_SESSION['rego']['formdate']['thm'].' พ.ศ. '.$_SESSION['rego']['formdate']['thy'].'</b><br>
						วันที่ : <b>'.$_SESSION['rego']['formdate'][$lang.'date'].'</span></b>
					</th>
				</tr>
				</thead>
			</table>';
...
$html .= '
			<table style="margin-top:10px" class="taxtable" border="0">
				...
				<tr>
					...
					<th style="width:30px">ประจำตัวผู้เสียภาษี</th>
					<th style="text-align:left">ชื่อ-สกุล</th>
					<th style="vertical-align:middle; width:110px">เงินสะสม</th>
					<th style="vertical-align:middle; width:110px">เงินสมทบ</th>
					<th style="vertical-align:middle; width:110px">เงินลงทุนรวม</th>
				</tr>
				</thead>
				<tbody>';
