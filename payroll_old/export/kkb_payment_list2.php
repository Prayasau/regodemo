<?php
	...
	$payroll_txt = "HDCT".str_repeat(' ', 8);
	$payroll_txt .= "000000".str_repeat(' ', 8);
	$payroll_txt .= $_account.' ';
	$payroll_txt .= sprintf("%015d",$tot_salary);
	$payroll_txt .= " 201030".str_repeat(' ', 8);
	$payroll_txt .= $compname.str_repeat(' ', (45 - mb_strlen($compname)));
		...
		<div class="tab-pane" id="tab_upload">
			<table style="width:100%; margin-bottom:5px;" border="0">
				<tr>
					...
					<td style="text-align:right">
						<button xdisabled type="button" class="btn btn-primary btn-fr" onclick="window.location.href='<?=ROOT?>payroll/export/download/download_kkb_payroll_textfile.php';"><i class="fa fa-download"></i>&nbsp; <?=$lng['Download']?></button>
					</td>
				</tr>
			</table>
