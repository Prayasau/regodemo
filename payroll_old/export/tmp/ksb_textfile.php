	...
	<div class="tab-content autoheight" style="padding:10px; min-height:400px; border:1px #ccc solid; border-top:0">
		...
		<div class="tab-pane" id="tab_upload">
			<table style="width:100%; margin-bottom:15px;" border="0">
				<tr>
					<td style="font-size:20px; font-weight:600"><?=$lng['Kungsri Bank']?> <?=$lng['Text file']?></td>
					<td style="text-align:right">
						<button disabled type="button" class="btn btn-primary btn-sm" onclick="window.location.href='<?=ROOT?>payroll/export/download/download_ksb_textfile.php';"><i class="fa fa-download"></i>&nbsp; <?=$lng['Download']?></button>
					</td>
				</tr>
			</table>
		...
		<div class="tab-pane active" id="tab_list">
			<table style="width:100%; margin-bottom:10px;" border="0">
				<tr>
					<td style="font-size:20px; font-weight:600"><?=$lng['Kungsri Bank']?> <?=$lng['Payment list']?></td>
					<td style="text-align:right">
