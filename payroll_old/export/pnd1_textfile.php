...
<?php
	...
	$txt = '';
	$nr = 1;
	$sql = "SELECT emp_id, gross_income, tax_month, calc_tax FROM ".$_SESSION['rego']['payroll_dbase']." WHERE month = '".$_SESSION['rego']['cur_month']."' AND entity = '".$_SESSION['rego']['gov_entity']."' AND emp_group = '".$_SESSION['rego']['emp_group']."' AND calc_tax = 1 ORDER by emp_id ASC";
