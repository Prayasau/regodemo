<?php
	...
	$columns[] = array( 'db' => 'emp_group', 'dt' => $nr); $nr++;
	...
	$columns[] = array( 'db' => 'id', 'dt' => $nr, 'formatter' => function($d, $row ){return '<a class="empPrint" data-id="'.$d.'"><i class="fa fa-print fa-lg"></i></a>';}); $nr++;
