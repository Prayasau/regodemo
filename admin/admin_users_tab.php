...
?>
			...
			<div class="dash-left">
				...
				<div class="dashbox <? if($_SESSION['RGadmin']['access']['admin']['access'] == 1){}else{echo 'disabled';}?>">
					<div class="inner" onclick="window.location.href='index.php?mn=30';"
					<? 
						if($_SESSION['RGadmin']['access']['admin']['access'] == 1){
				...
				<div class="dashbox <? if($_SESSION['RGadmin']['access']['users']['access'] == 1){}else{echo 'disabled';}?>">
					<div class="inner" onclick="window.location.href='index.php?mn=31';"
					<? 
				...
				<div class="dashbox <? if($_SESSION['RGadmin']['access']['users']['access'] == 1){}else{echo 'disabled';}?>">
					<div class="inner" onclick="window.location.href='index.php?mn=32';"
					<? 
						if($_SESSION['RGadmin']['access']['users']['access'] == 1){
