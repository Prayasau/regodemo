<?
	...
	$sql = "UPDATE rego_default_shiftplans SET cycle_details = '".$dba->real_escape_string(serialize($months))."',dates = '".$dba->real_escape_string(serialize($months))."', wkd = '".$dba->real_escape_string(serialize($workingDaysArray))."' WHERE id= '".$_POST['hidden_code_id']."'";
