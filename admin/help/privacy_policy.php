...
<style>
	...
	<form id="termsForm">
	<h2><i class="fa fa-file-text-o fa-lg"></i>&nbsp;&nbsp;Privacy policy<button class="btn btn-primary" style="float:right; margin-top:3px"><i class="fa fa-save"></i>&nbsp; Update</button></h2>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$("#termsForm").submit(function(e){ 
				...
				$.ajax({
					url:"help/ajax/update_privacy_policy.php",
					data: data,
					type: 'POST',
