							...
							<table  id="datatables22" class="dataTable hoverable selectable nowrap" >
								...
								<thead>
									<tr>
										...
										<th class='tal'><?=$lng['Calculate tax']?></th>
										<th class='tal'><?=$lng['Tax Residency Status']?></th>
										<th class='tal'><?=$lng['Income Section']?></th>
...
//======================== VIEW TEAMS MODAL OPEN  =========================//
		...
		function divselect(it){
			//disableall();
			switch(it){
			case 1:$('#div_personal').css("display","");
    			$('#personal_old_data').css("display","");
    			break;
			// contact section
			case 2:$('#div_contacts').css("display","none");
    			$('#contacts_old_data').css("display","none");
    			break;
			// workd data section
			case 3:$('#div_work_data').css("display","none");
    			$('#work_data_old_data').css("display","none");
    			break;
			// time section
			case 4:$('#div_time').css("display","none");
    			$('#time_old_data').css("display","none");
    			break;
			// leave section
			case 5:$('#div_leave').css("display","none");
    			$('#leave_old_data').css("display","none");				
    			break;
			// organization section
			case 6:$('#div_organization').css("display","none");
    			$('#organization_old_data').css("display","none");
    			break;
			case 8:$('#div_benfits').css("display","none");
    			$('#benefits_old_data').css("display","none");
    			break;
			case 9:break;
			}
...
/////////////////
			divselect(value);
			v2=(int)value+1;
			console.log($("select#showHideclm"+(v2)+""));
			$("select#showHideclm"+(v2)+"")[0].sumo.selectAll();	

			var columns =[];
			$('#showHideclm'+(value+1)+' option:selected').each(function(i) {
		  
		    	 columns.push($(this).val());

		    });

	    	var att_cols = colup(value,columns);;
			/* $.each(columns, function(index, item) {
				att_cols.push({id:item, db:tableCols2[item][0], name:tableCols2[item][1]})
			}) */
...
function showhideclm(it){
	$("#showHideclm"+it).closest("div").css('display','');
} 

function selectdiv(it){
	disableall();
	switch(it){
	case 1:$('#personal_div_data').css('display','');break;
	case 2:$('#country_div_data').css('display','');break;
	case 3:$('#work_div_data').css('display','');break;
	case 4:$('#time_div_data').css('display','');break;
	case 5:$('#leave_div_data').css('display','');break;
	case 6:$('#organization_div_data').css('display','');break;
	case 7:break;
	case 8:$('#benefits_div_data').css('display','');break;
	case 9:break;
	}
	showhideclm(it);
}
