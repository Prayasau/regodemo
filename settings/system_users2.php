...
<style>
    ...
    <form id="permissionForm" style="position:relative">
    	<fieldset disabled>
			...
			<table class="basicTable" style="margin-top:0px; width:100%; table-layout:auto">
				...
				<tbody>
					<tr>
						<td style="font-weight:600; min-width:180px"><i class="fa fa-check-square fa-lg" style="margin-right:8px; color:#0066FF"></i>Entities</td>
						<td colspan="20" style="padding:0; vertical-align:top; white-space:normal">
							<input id="selEntities" name="entities" type="text" placeholder="Pick a entity ...">
						</td>
					</tr>
					<tr>
						<td style="font-weight:600"><i class="fa fa-check-square fa-lg" style="margin-right:8px; color:#0066FF"></i>Branches</td>
						<td colspan="20" style="padding:0; vertical-align:top; white-space:normal">
							<input id="selBranches" name="branches" type="text" placeholder="Pick a branch ...">
						</td>
					</tr>
					<tr>
						<td style="font-weight:600"><i class="fa fa-check-square fa-lg" style="margin-right:8px; color:#0066FF"></i>Divisions</td>
						<td colspan="20" style="padding:0; vertical-align:top; white-space:normal">
							<input id="selDivisions" name="divisions" type="text" placeholder="Pick a division ...">
						</td>
					</tr>
					<tr>
						<td style="font-weight:600"><i class="fa fa-check-square fa-lg" style="margin-right:8px; color:#0066FF"></i>Departments</td>
						<td colspan="20" style="padding:0; vertical-align:top; white-space:normal">
							<input id="selDepartments" name="departments" type="text" placeholder="Pick a department ...">
						</td>
					</tr>
					<tr>
						<td style="font-weight:600"><i class="fa fa-check-square fa-lg" style="margin-right:8px; color:#0066FF"></i>Teams</td>
						<td colspan="20" style="padding:0; vertical-align:top; white-space:normal">
							<input id="selTeams" name="teams" type="text" placeholder="Pick a team ...">
						</td>
					</tr>
					<tr>
			...
			<table class="basicTable" style="margin-top:0px; width:100%; table-layout:auto">
				<thead>
					<tr style="line-height:100%; background:#f6f6f6; border-bottom:1px solid #ddd">
						<th class="tal">Module</th>
						<th class="tal">Section</th>
						<th colspan="20" style="width:90%">Permissions</th>
					</tr>
				</thead>
				<tbody>
	...
	$(document).ready(function() {
		...
		var selEntities = $('#selEntities').selectize({
			maxItems: null,
			valueField: 'key',
			labelField: 'value',
			searchField: 'value',
			...
			load: function (query, callback) {
				$.ajax({
					url: 'ajax/get_permission_array_json.php',
					data: {type: 'entities'},
					dataType: 'json',
		...
		var selBranches = $('#selBranches').selectize({
			maxItems: null,
			valueField: 'key',
			labelField: 'value',
			searchField: 'value',
		...
		var selDivisions = $('#selDivisions').selectize({
			maxItems: null,
			valueField: 'key',
			labelField: 'value',
			searchField: 'value',
		...
		var selDepartments = $('#selDepartments').selectize({
			maxItems: null,
			valueField: 'key',
			labelField: 'value',
			searchField: 'value',
		...
		var selTeams = $('#selTeams').selectize({
			maxItems: null,
			valueField: 'key',
			labelField: 'value',
			searchField: 'value',
		...
		/*var $pselect = $('#selDepartments').selectize({
					options: [
						{id: 'all', title: 'All departments'},
						{id: 1, title: 'Graphics'},
						{id: 2, title: 'Cleaning'},
						{id: 3, title: 'Research'},
						{id: 4, title: 'Acounting'},
						{id: 5, title: 'Painting'}
					],
			create: false,
			delimiter: ',',
			...
			load: function (query, callback) {
				$.ajax({
					url: 'ajax/get_required_pallets_json.php',
					type: 'POST',
					dataType: 'json',
					data: {
						 id: cid,
		...
		function getPermissionData(id, copy){
			...
			$.ajax({
				...
				success:function(data){
					...
					selEntities[0].selectize.setValue((data.entities).split(','));
					selBranches[0].selectize.setValue((data.branches).split(','));
					selDivisions[0].selectize.setValue((data.divisions).split(','));
					selDepartments[0].selectize.setValue((data.departments).split(','));
					selTeams[0].selectize.setValue((data.teams).split(','));
					
					selEntities[0].selectize.enable();
					selBranches[0].selectize.enable();
					selDivisions[0].selectize.enable();
					selDepartments[0].selectize.enable();
					selTeams[0].selectize.enable();
