<?
	...
	$sql = "UPDATE ".$cid."_shiftplans_".$cur_year." SET cycle_details = '".$dbc->real_escape_string(serialize($months))."', wh_code = '".$_POST['shift_schedule1']."' ,dates = '".$dbc->real_escape_string(serialize($months))."', wkd = '".$dbc->real_escape_string(serialize($workingDaysArray))."' WHERE id= '".$_POST['hidden_code_id']."'";
