...
<style>
	...
	<div style="height:100%; border:0px solid red; position:relative">
		...
		<div class="breadcrumbs">
			<a onClick="location.reload()"><i class="fa fa-file-invoice" ></i> &nbsp;<?=$lng['Document templates']?> : Readonly</a>
		...
		<div style="position:absolute; left:40%; top:33px; right:0; bottom:0; background: #f6f6f6; border-left:1px solid #ddd">
			...
			<div id="rightTable" style="position:absolute; left:15px; top:45px; right:15px; bottom:15px; background:; overflow-Y:auto; padding:0px; display:xnone">



				<div style="background:#fff; padding:25px">
					<div style="margin-bottom:10px">
						<span style="font-size:20px; font-weight:600; border-bottom:1px solid #ddd;"><?=$lng['Invoice']?> # <i style="color:#999">INV1800001</i></span><br>
					</div>
					...
					<div id="words" style="text-align:right; padding-top:10px">--- Six thousand three hundred and ninety Bath Only ---</div>
				</div>
				...
				<div style="background:#fff; padding:25px">
					...
					<table class="itemsTable" border="0" style="table-layout:auto">
						<thead>
							<tr>
								<th colspan="2" style="text-align:left; width:80%"><?=$lng['Description']?></th>
								<th style="width:10%"><?=$lng['VAT']?> %</th>
								<th style="width:10%"><?=$lng['Amount']?></th>
								<th style="width:5%" class="pl0"><small><?=$currency?></small></th>
							</tr>
						...
						<tbody>
							...
							<tr>
								<td colspan="2" style="border-bottom:0; width:80%"></td>
								<th style="border-bottom:1px solid #eee"><?=$lng['Subtotal']?></th>
								<td style="border-bottom:1px solid #eee"><?=number_format(6000,2)?></td>
								<td style="border-bottom:1px solid #eee" class="pl0"><small><?=$currency?></small></td>
							</tr>
							<tr>
								<td colspan="2" style="border-bottom:0"></td>
								<th style="border-bottom:1px solid #999"><?=$lng['VAT']?></th>
								<td style="border-bottom:1px solid #999"><?=number_format(420,2)?></td>
								<td style="border-bottom:1px solid #999" class="pl0"><small><?=$currency?></small></td>
							</tr>
							<tr>
								<td colspan="2" style="border-bottom:0"></td>
								<th style="border-bottom:2px solid #999"><?=$lng['Grand total']?></th>
								<td style="border-bottom:2px solid #999"><?=number_format(6420,2)?></td>
								<td style="border-bottom:2px solid #999" class="pl0"><small><?=$currency?></small></td>
							</tr>
						</tbody>
